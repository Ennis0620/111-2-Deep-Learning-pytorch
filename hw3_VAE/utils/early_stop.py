...
class early_stop:
    ...
    def save_checkpoint(self,
        ...
        path = f'{self.save_path}/epoch_{performance_value[0]}_trainLoss_{performance_value[1]}_trainFID_{performance_value[2]}_valLoss_{performance_value[3]}_valFID_{performance_value[4]}.pth'
        if 'acc' in self.monitor :
            if perform_matrix >= 0.3:

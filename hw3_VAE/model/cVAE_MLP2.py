...
class cVAE_Encoder(nn.Module):
    def __init__(self, input_image, latent_z, class_num, device):
        ...
        self.liner1 = nn.Linear(input_image + class_num, 1024)
        self.liner2 = nn.Linear(1024, 512)
        self.liner3 = nn.Linear(512, 256)
...
class cVAE_Decoder(nn.Module):
    def __init__(self, input_image, latent_z, class_num, device):
        ...
        self.liner4 = nn.Linear(1024, input_image)
